...
##################################
# ooolib-python Draw Meta object #
##################################
class Meta:
    ...
    def updateStatistics(self):
        pageCount = self.global_object.getGlobalInt("drawPageCount")
        self.documentStatistic.setAttribute("meta:page-count", pageCount)
...
if __name__ == "__main__":
    ...
    print("Draw Meta XML with indentation:")
    print(string1)
