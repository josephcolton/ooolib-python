...
##########################################
# ooolib-python Impress Manifest object  #
##########################################
class Manifest:
    def __init__(self, global_object):
        ...
        fileEntry1.setAttribute("manifest:media-type", "application/vnd.oasis.opendocument.presentation")
...
if __name__ == "__main__":
    ...
    print("Impress Manifest XML with indentation:")
    print(string1)
