...
####################################
# ooolib-python Impress Meta object #
####################################
class Meta:
    def __init__(self, global_object):
        ...
        self.officeMeta.addChild(ooolibXML.Element("meta:creation-date", dateStr))
    ...
    def updateStatistics(self):
        slideCount = self.global_object.getGlobalInt("slideCount")
        self.documentStatistic.setAttribute("meta:page-count", slideCount)
...
if __name__ == "__main__":
    ...
    print("Impress Meta XML with indentation:")
    print(string1)
