...
########################################
# ooolib-python Draw Manifest object   #
########################################
class Manifest:
    def __init__(self, global_object):
        ...
        fileEntry1.setAttribute("manifest:media-type", "application/vnd.oasis.opendocument.graphics")
...
if __name__ == "__main__":
    ...
    print("Draw Manifest XML with indentation:")
    print(string1)
