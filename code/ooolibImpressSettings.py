...
######################################
# ooolib-python Impress Settings object #
######################################
class Settings:
    def __init__(self, global_object):
        ...
        self.addConfigItem(configSet, "IsPresentationRunning", "boolean", "false")
        ...
        self.addConfigItem(configSet, "SlideShowPresentationStart", "int", "1")
...
if __name__ == "__main__":
    ...
    print("Impress Settings XML with indentation:")
    print(string1)
